...
(function installCuttingJobImporterAdmin(){
  ...
  if(!file||!previewBtn||!reviewed||!run||!status||!rows||!window.cuttingJobImporter)return;let parsed=null,classified=null;const safe=value=>String(value??"").replace(/[&<>"']/g,ch=>({"&":"&amp;","<":"&lt;",">":"&gt;","\"":"&quot;","'":"&#39;"}[ch]));
