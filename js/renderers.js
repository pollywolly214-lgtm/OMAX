      ...
      <details class="task task--${type}" data-task-id="${t.id}" data-owner="${type}" data-editing="0">
        ...
        <div class="body">
          ...
          <div class="grid">
            ...
            <label data-field="downtimeHours">Down time (hrs)<input type="number" step="0.25" min="0" data-k="downtimeHours" data-id="${t.id}" data-list="${type}" value="${(typeof readTaskDowntimeHours === "function" ? (readTaskDowntimeHours(t) ?? "") : (Number.isFinite(Number(t?.downtimeHours)) && Number(t.downtimeHours) >= 0 ? Number(t.downtimeHours) : ""))}" placeholder="optional"></label>
