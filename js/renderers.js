...
function computeCostModel(){
  ...
  const buildMaintenanceRows = (taskList, modeLabel)=>{
    ...
    (Array.isArray(taskList) ? taskList : []).forEach((task, index) => {
      ...
      const timeCostTwoMonth = totalHoursTwoMonth * safeMaintenanceLaborRate;
      ...
      const partCostYear = unitCostSafe * completedYear;
      const partCostTwoMonth = unitCostSafe * completedTwoMonth;
      const totalCostYear = partCostYear + timeCostTotal;
      const totalCostTwoMonth = partCostTwoMonth + timeCostTwoMonth;
      rows.push({
        ...
        timeCostTwoMonthLabel: formatterCurrency(timeCostTwoMonth, { decimals: timeCostTwoMonth < 1000 ? 2 : 0 }),
        partCostYearLabel: unitCostSafe > 0
          ? formatterCurrency(partCostYear, { decimals: partCostYear < 1000 ? 2 : 0 })
          : "—",
        partCostTwoMonthLabel: unitCostSafe > 0
          ? formatterCurrency(partCostTwoMonth, { decimals: partCostTwoMonth < 1000 ? 2 : 0 })
          : "—",
    ...
    sections: [
      {
        ...
        rows: intervalTaskRowsRaw.map(row => ({
          ...
          partCostYearLabel: row.partCostYearLabel,
          partCostTwoMonthLabel: row.partCostTwoMonthLabel,
