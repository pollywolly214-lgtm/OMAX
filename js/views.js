        ...
        <table class="forecast-table">
          <thead>
            <tr>
              ...
              <th scope="col">Parts total (12 mo)</th>
              <th scope="col">Parts total (2 mo)</th>
          ...
          <tbody>
            ${breakdownSections.map(section => {
              ...
              <tr>
                ...
                <td>${esc(row.timeCostTwoMonthLabel || "—")}</td>
                <td>${esc(row.partsTotalYearLabel || "—")}</td>
                <td>${esc(row.partsTotalTwoMonthLabel || "—")}</td>
            ...
            `).join("")
              ...
              <tr class="forecast-empty-row">
                <td colspan="15">${esc(section.emptyMessage || "No tasks yet.")}</td>
              </tr>`;
  ...
  <div class="container cost-container">
    ...
    <div class="forecast-modal" id="forecastBreakdownModal" role="dialog" aria-modal="true" aria-labelledby="forecastModalTitle" hidden aria-hidden="true">
      ...
      <div class="forecast-modal-card" role="document" tabindex="-1" data-forecast-initial>
        ...
        <p class="forecast-modal-subtitle">Completed maintenance with 12-month totals and 2-month averages.</p>
        ${forecastTableHTML}
