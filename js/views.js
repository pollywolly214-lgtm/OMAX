      ...
      <div class="dashboard-window" data-cost-window="chart">
        <div class="block cost-chart-block">
          ...
          <div class="small muted" style="display:flex;gap:14px;flex-wrap:wrap;margin-top:8px;">
            <span style="color:${esc(chartColors.maintenance)};"><strong>Avg maintenance cost/completed cut:</strong> <span data-maint-cost-per-cut-label>${esc(data.maintenanceCostPerCutLabel || "$0")}</span></span>
