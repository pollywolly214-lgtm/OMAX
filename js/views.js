      ...
      <div class="job-note-modal-backdrop" id="jobOneDriveExplorerModal" hidden>
        <div class="job-note-modal" role="dialog" aria-modal="true" aria-labelledby="jobOneDriveExplorerTitle">
          ...
          <div class="job-note-modal-body">
            ...
            <div class="job-onedrive-direct-attach">
              <label class="job-edit-note">Paste OneDrive file link (from tab above) to attach directly
                <input type="url" id="jobOneDriveFileLink" placeholder="https://... (OneDrive file share URL)">
              </label>
              <button type="button" class="job-note-modal-primary" id="jobOneDriveAttachLinkBtn">Attach from link</button>
            </div>
